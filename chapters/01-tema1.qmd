...
Aunque estas variables no representan cantidades numéricas, también pueden incorporarse a un modelo econométrico mediante técnicas en las que profundizaremos en el @sec-tema3. 
...
$$
ROA_i=\beta_0+\beta_1LEV_i+\beta_2LIQ_i+\beta_3D_1+u_i
$$
los parámetros son:
...
Se estudiará en mayor detalle en el tema @sec-tema3.
